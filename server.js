...
// server.js - The main backend file for the application, adapted for Vercel
...
// Set up the database connection
// IMPORTANT: Use your correct MongoDB Atlas connection string
const dbURI = 'mongodb+srv://georgeortman19_db_user:lPcV6yRWZCIsvyTJ@cluster0.8llntck.mongodb.net/';
mongoose.connect(dbURI)
    .then(() => console.log('MongoDB connected successfully'))
    .catch(err => console.error('MongoDB connection error:', err));
...
// Route to serve the homepage (this is no longer needed with vercel.json rewrites)
// app.get('/', (req, res) => {
//     res.sendFile(path.join(__dirname, 'public', 'signup.html'));
// });
...
// We no longer use app.listen(). Instead, we export the Express app.
// This allows Vercel's serverless function to handle the requests.
module.exports = app;
